...
function CommentList({comments, postId}: {comments: CommentWithUser[], postId: number }) {
    ...
    return (
        <>
            ...
            <div className='flex items-center gap-4'>
                ...
                <form action={handlerAddComment} className='flex-1 flex items-center justify-between bg-slate-100 rounded-xl text-sm px-6 py-2 w-full'>
                    <input type='text' placeholder='Write a comment...' className='bg-transparent outline-none flex-1' onChange={(e) => setDesc(e.target.value)} value={desc} />
